...
`,
  ...
  initialize: function () {
    ...
    this.attr('.color-band/fill', getSettings.getBlockHeaderColor())
    this.attr('.background/fill', getSettings.getBlockBackgroundColor())
    this.attr('.background/stroke', getSettings.getBlockBorderColor())
    this.attr({
      '.status': {
        fill: '#0083FF',
        width: 99,
